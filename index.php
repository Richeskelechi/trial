...
<html>
<head>
	<title>Vinns Courier Services</title>
...
<header>
 ...
 <a class="navbar-brand" href="index.html">Vinns C<span><i class="fab fa-empire"></i></span>urier</a>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <div class="navbar-text">
     <p class="right-p"><i class="fas fa-phone" aria-hidden="true"></i>7085733574</p>
    </div>
  </div>
</nav>
		</div>
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<div class="carousel-caption">
						...
						<p>Vinns Courier Services offer a diverse range of transportation services from project cargo to international transportation and domestic retail distribution and delivery.</p>
				...
				<div class="agileinfo_banner_bottom_pos">
					<div class="w3_agileits_banner_bottom_pos_grid">
						...
						<div class="col-xs-9 wthree_banner_bottom_grid_right">
							...
							<p>Vinns Courier Services is a superior and expert express shipping company.</p>
			...
			<div class="col-lg-4 agileits_banner_bottom_left">
				<div class="agileinfo_banner_bottom_pos">
					<div class="w3_agileits_banner_bottom_pos_grid">
						...
						<div class="col-xs-9 wthree_banner_bottom_grid_right">
							<h4>AIR FREIGHT</h4>
							<p> Vinns Courier Services can handle all of your global forwarding /shipping / logistics solutions.</p>
				...
				<div class="agileinfo_banner_bottom_pos">
					<div class="w3_agileits_banner_bottom_pos_grid">
						...
						<div class="col-xs-9 wthree_banner_bottom_grid_right">
							...
							<p>Step-by-step we provide the details needed to ensure expedient and profitable export transactions.</p>
	...
	<div class="services-bottom wthree-sub py-5" id="about">
		<div class="container py-md-3">
			...
			<div class="col-sm-6 col-xs-4 services_bottom_grid_left">
				...
				<p>Imports – Air, Ocean, Land or Rails</p>
	...
	<div class="testimonials  py-5" id="services">
		<div class="container  py-md-3">
			...
			<div class="w3_testimonials_grids">
					...
					<div class="flexslider">
						<ul class="slides">
								...
								<div class="about-top w3ls-agile row">
									...
									<div class="col-md-6 come">
										<div class="about-wel">
											...
											<p>Vinns Courier Services is a superior, express shipping company. Although the Company has been in practice for over 20 years, the founders offer in excess of 30 years valuable industry experience. Our extensive knowledge of the express delivery market allows Vinns Courier Services to offer our clients an array of different shipping options from our unsurpassed worldwide and local distribution network.</p>
											<ul>
												<li>
							...
							<li>
								<div class="about-top w3ls-agile row">
				<div class="col-md-6 ser_w3">
					<img class="img-responsive img-fluid" src="images/services3.jpg" alt="">
				</div>
				<div class="col-md-6 come">
					<div class="about-wel">
						<h5>A Few Words About Our
				...
				<div class="col-md-6 ser_w3">
					<img class="img-responsive img-fluid" src="images/service4.jpg" alt="" >
				</div>
			</div>
			...
			<div class="row inner-sec-w3layouts-agileinfo">
				...
				<div class="col-md-4  proj_gallery_grid" data-aos="zoom-in">
					<div class="section_1_gallery_grid">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/gal1.jpg" class="img-fluid">
							<div class="section_1_gallery_grid1">
								<img src="images/gal1.jpg" alt=" " class="img-responsive img-fluid" />
								<div class="proj_gallery_grid1_pos">
									<h3>Transport By Tankers</h3>
					...
					<div class="section_1_gallery_grid" data-aos="zoom-in">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/gal2.jpg" class="img-fluid">
							<div class="section_1_gallery_grid1">
								<img src="images/gal2.jpg" alt=" " class="img-responsive img-fluid" />
								<div class="proj_gallery_grid1_pos">
									<h3>Transport By Motor Cargo</h3>
					...
					<div class="section_1_gallery_grid" data-aos="zoom-in">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/gal3.jpg" class="img-fluid">
							<div class="section_1_gallery_grid1">
								<img src="images/gal3.jpg" alt=" " class="img-responsive img-fluid" />
								<div class="proj_gallery_grid1_pos">
									<h3>Transport By Trailers</h3>
				...
				<div class="col-md-4  proj_gallery_grid" data-aos="zoom-in">
					<div class="section_1_gallery_grid">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/gal4.jpg" class="img-fluid">
							<div class="section_1_gallery_grid1">
								<img src="images/gal4.jpg" alt=" " class="img-responsive img-fluid" />
								<div class="proj_gallery_grid1_pos">
									<h3>Transport By Ship</h3>
					...
					<div class="section_1_gallery_grid" data-aos="zoom-in">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/gal5.jpg" class="img-fluid">
							<div class="section_1_gallery_grid1">
								<img src="images/gal5.jpg" alt=" " class="img-responsive img-fluid"/>
								<div class="proj_gallery_grid1_pos">
									<h3>Transport By Airplane</h3>
					...
					<div class="section_1_gallery_grid" data-aos="zoom-in">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/gal6.jpg" class="img-fluid">
							<div class="section_1_gallery_grid1">
								<img src="images/gal6.jpg" alt=" " class="img-responsive img-fluid" />
								<div class="proj_gallery_grid1_pos">
									<h3>Transport By Airplane</h3>
				...
				<div class="col-md-4  proj_gallery_grid" data-aos="zoom-in">
					<div class="section_1_gallery_grid">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/gal7.jpg" class="img-fluid">
							<div class="section_1_gallery_grid1">
								<img src="images/gal7.jpg" alt=" " class="img-responsive img-fluid" />
								<div class="proj_gallery_grid1_pos">
									<h3>Transport By Rails</h3>
					...
					<div class="section_1_gallery_grid" data-aos="zoom-in">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/gal8.jpg" class="img-fluid">
							<div class="section_1_gallery_grid1">
								<img src="images/gal8.jpg" alt=" " class="img-responsive img-fluid" />
								<div class="proj_gallery_grid1_pos">
									<h3>Transport By Rails</h3>
					...
					<div class="section_1_gallery_grid" data-aos="zoom-in">
						<a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est." href="images/gal9.jpg" class="img-fluid">
							<div class="section_1_gallery_grid1">
								<img src="images/gal9.jpg" alt=" " class="img-responsive img-fluid" />
								<div class="proj_gallery_grid1_pos">
									<h3>Transport By Lorries</h3>
...
<section class="newsletter text-center py-5">
	<div class="container py-md-3">
		...
		<div class="w3l_header_contact_details_agile">
												<p>Give us a Call</p>
												<a class="w3l_header_contact_details_agile-info_inner"> <span><i class="fas fa-phone"></i></span>7085733574</a>
											</div>

		<div class="subscribe_inner">
			<p class="mb-4">Vinns Courier Services is a superior, express shipping company. Although the Company has been in practice for over 20 years, the founders offer in excess of 30 years valuable industry experience.</p>
...
<footer>
	<div class="container py-3 py-md-4">
		<div class="footer">
				<p class="text-center">© 2018 Transload. All Rights Reserved | Design by <a href="#" target="_blank">W3Layouts</a></p>
			</div>
	</div>
</footer>
<!-- footer -->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-uppercase" id="exampleModalLongTitle">Vinns Courier Services</h5>
      ...
      <div class="modal-body">
        ...
        Vinns Courier Services is a superior, express shipping company. Although the Company has been in practice for over 20 years, the founders offer in excess of 30 years valuable industry experience. Our extensive knowledge of the express delivery market allows Vinns Courier Services to offer our clients an array of different shipping options from our unsurpassed worldwide and local distribution network.      </div>
